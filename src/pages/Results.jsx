...
export default function Results() {
  ...
  const generateHeatmap = () => ({ weeks: githubData.contributionCalendar.weeks });
      ...
      <header className="border-b border-[#30363d] bg-[#020408]">
        <div className="max-w-full mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-4">
          ...
          >
            ...
            />
            <h1 className="text-lg sm:text-2xl font-bold text-white hidden sm:block">
              AmICooked?
            </h1>
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="flex items-center gap-3 text-gray-300">
                    ...
                    <span className="text-white ml-auto text-xs">
                      {userProfile?.experienceYears?.replace(/_/g, " ") || "N/A"}
                    </span>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="lg:col-span-9 space-y-6">
            <div>
              ...
              <Card className="bg-[#0d1117] pt-5 border-[#303d] overflow-hidden">
                  ...
                  <div className="min-w-0">
                    ...
                    {analysis.recommendations &&
                      analysis.recommendations.length > 0 && (
                        <div>
                          <button
                            onClick={() => setMetricPopupOpen((v) => !v)}
                          ...
                          <div
                            className={`transition-all duration-300 ease-in-out overflow-hidden ${
                              metricPopupOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                            }`}
                          >
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="flex flex-col items-center gap-1 shrink-0">
                          ...
                          <span
                            className={`text-xs font-semibold ${getCookedColor(
                              analysis.cookedLevel
                            )}`}
                          >
                            {analysis.levelName}
                          ...
                          >
                            <Bookmark
                              className={`w-3.5 h-3.5 ${
                                savedProjectNames.has(rec.name) ? "fill-current" : ""
                              }`}
                            />
                          </button>
                        </div>
                          ...
                          <div className="flex">
                            {(() => {
                              ...
                              for (const week of heatmap.weeks) {
                                const midIdx =
                                  Math.floor(week.contributionDays.length / 2) ||
                                  0;
                                const dateStr =
                                  week.contributionDays[midIdx]?.date ||
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="overflow-auto">
                            <div
                              ...
                              style={{ minWidth: `${heatmap.weeks.length * 14}px` }}
                            >
      ...
      {metricPopupOpen && analysis.categoryScores && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-[#161b22] border border-[#30363d] rounded-xl p-5 max-w-sm w-full mx-4 shadow-2xl">
            ...
            <div className="mt-4 pt-3 border-t border-[#303d] flex items-center justify-between">
